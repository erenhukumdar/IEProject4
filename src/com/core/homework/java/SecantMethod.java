...
public class SecantMethod {
	...
	public double getInitialValueOfX1()
	{		
		return getU();
	}
	public double performSecant()
	{
		...
		double xPrev=getInitialValueOfX1();
	    ...
	    do{
			...
			double xNew = x- (getFunctionDerivative(x)*((x-xPrev)/(getFunctionDerivative(x)-getFunctionDerivative(xPrev))));
